...
```bash
dotnet dev-certs https -v -ep authserver.pfx -p 3d352fed-522f-4314-8879-0b65645d4c8f
```

> `3d352fed-522f-4314-8879-0b65645d4c8f` is the password of the certificate, you can change it to any password you want.
